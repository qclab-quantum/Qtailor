...
if __name__ == "__main__":
    ...
    smd['qasm'] = 'amplitude_estimation/ae_indep_qiskit_10.qasm'
    set_logger()
    args = parser.parse_args()
    print(f"Running with following CLI options: {args}")
    #train()
    test_result(checkpoint='C:/Users/Administrator/ray_results/PPO_2023-12-24_21-49-07/PPO_CircuitEnvTest_v4_35829_00000_0_2023-12-24_21-49-07/checkpoint_000000')
    smd.shm.close()
    smd.shm.unlink()
